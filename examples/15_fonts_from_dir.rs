...
fn main() -> Result<()> {
    ...
    let pdf = DocumentBuilder::new("Fontes de Directório")
        ...
        .push(Paragraph::new(
            "Texto com LiberationSans (default após load_dir).",
        ))
        .push(Paragraph::new("Texto com LiberationSerif.").font_family("LiberationSerif"))
        .push(Paragraph::new("Texto com LiberationMono.").font_family("LiberationMono"))
        .push(Spacer::new(4.0))
        .push(Paragraph::new("Alias Word: 'Arial' → LiberationSans.").font_family("Arial"))
        .push(
            Paragraph::new("Alias Word: 'Times New Roman' → LiberationSerif.")
