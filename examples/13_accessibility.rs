...
use normordis_pdf::{
    ...
    InstitutionalHeader, ListItemElement, OrderedList, PageFooter, Paragraph,
    PdfStandard, Result, Section, Spacer, StructTag, Table, TableCell,
    TextAlign,
};
...
fn main() -> Result<()> {
    ...
    let pdf = DocumentBuilder::new("Relatório de Actividades — Acessível")
        ...
        .push(Paragraph::new("A divisão de urbanismo emitiu 84 licenças em 2026."))
        .push(
